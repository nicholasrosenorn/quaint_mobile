...
export default function MindfulnessModalFooter() {
		...
		<View style = {styles.ButtonRow}>
			...
			<Link href="../" asChild>
				...
				<View style = {styles.NewTaskButton}>
					<TouchableOpacity >
						<Text style={{color: Colors[colorScheme ?? 'light'].text}}>Generate a new daily mindfulness?</Text>
					</TouchableOpacity>
				</View>
		</View>
	</View>
